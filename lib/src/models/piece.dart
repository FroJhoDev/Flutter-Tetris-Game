...
import 'package:tetris/src/pages/board_page.dart';
...
class Piece {
  ...
  void rotatePiece() {
    ...
    switch (type) {
      case Tetromino.L:
        ...
        switch(rotationState) {
          case 0:
            ...
            // check that this new position is a valid move before assignig it to the real position
      ...
      case Tetromino.O:
        ...
        // The O tetromino does not need to be rotaded 
  ...
  bool piecePositionIsValid(List<int> piecePosition) {
    ...
    for (var pos in piecePosition) {
      ...
      // check if the first or last colum is occupied
      if (col == 0) {
